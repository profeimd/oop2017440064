...
public class Point {
	...
	public void print() {
		...
		System.out.println("(" + this.x + ", " + this.y + ")"); //this 꼭 있어야 하는 건 아님
							// 그리고 여기서는 바로 toString 쓰면 에러 뜸 -> primitive (double) type이기 때문 -> 알아서 reference (double) type으로 바꿔주고 toString 적용
							// toString의 반환형이 String이기 때문에 primitive type의 매개변수면 오류가 뜨는 거! String은 refrence 변수여야 함!
	}
